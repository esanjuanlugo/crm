...
interface Turn {
  role: 'user' | 'assistant';
  content: string;
  /** Solo para el asistente: el agente indicó que debe transferir la conversación a una persona. */
  handoff?: boolean;
}
  ...
  const send = async () => {
    ...
    try {
      ...
      if (!res.ok) {
        ...
        // Deshacemos el mensaje del usuario que no se pudo enviar
        ...
        {turns.length === 0 && (
          <div className="flex h-full flex-col items-center justify-center text-center text-sm text-muted-foreground">
            ...
            {onGoToSetup && (
              ...
              >
                ¿Todavía no está configurado? Ir a Configuración
