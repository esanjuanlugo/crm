...
function SignupPageInner() {
  ...
  const handleSignup = async (e: React.FormEvent) => {
    ...
    // URL de producción definida mediante variable de entorno
    ...
    // URL a la que Supabase enviará al usuario después
    // de confirmar su correo electrónico.
    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <Card className="w-full max-w-md border-border bg-card">
        <CardHeader className="items-center text-center">
          ...
          <CardDescription className="text-muted-foreground">
            {inviteToken ? t("inviteDescription") : t("description")}
          </CardDescription>
        </CardHeader>
        <CardContent>
          <form onSubmit={handleSignup} className="flex flex-col gap-4">
            ...
            >
              {loading ? t("creatingAccount") : t("submitButton")}
            </Button>
          </form>
